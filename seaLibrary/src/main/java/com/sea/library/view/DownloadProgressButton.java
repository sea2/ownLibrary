...
public class DownloadProgressButton extends TextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mBackgroundColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_color, Color.parseColor("#FEC42B"));
            mBackgroundSecondColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_second_color,
                    Color.parseColor("#eadcc4"));
            mButtonRadius = a.getDimension(R.styleable.DownloadProgressButton_progress_btn_radius, 0);
            mTextColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_text_color, Color.parseColor("#744C24"));
//            mTextCoverColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_text_cover_color, Color.WHITE);
            mTextCoverColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_text_cover_color,  Color.parseColor("#744C24"));
            mBorderWidth = a.getDimension(R.styleable.DownloadProgressButton_progress_btn_border_width, dp2px(2));
            btn_text_size = a.getDimension(R.styleable.DownloadProgressButton_progress_btn_text_size, dp2px(14));
    ...
    private void init() {
        ...
        mTextPaint.setTextSize(btn_text_size);
    ...
    private void drawBackground(Canvas canvas) {
        ...
        //color
        //先创建一个渲染器
        int [] colors = {Color.parseColor("#FFE86F"),Color.parseColor("#FECD3C")};

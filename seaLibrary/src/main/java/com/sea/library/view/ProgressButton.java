...
public class ProgressButton extends View {
    ...
    private void initResources(AttributeSet attrs, int defStyleAttr) {
        final TypedArray attributes = getContext().getTheme()
                .obtainStyledAttributes(attrs, R.styleable.ProgressButton, defStyleAttr, 0);

        textSize = attributes.getDimension(R.styleable.ProgressButton_progress_text_size, DEFAULT_TEXT_SIZE);
        mReachedAreaColor = attributes.getColor(R.styleable.ProgressButton_progress_reached_color, DEFAULT_REACHED_AREA_COLOR);
        mUnReachedAreaColor = attributes.getColor(R.styleable.ProgressButton_progress_unreached_color, DEFAULT_UNREACHED_AREA_COLOR);
        mBorderColor = attributes.getColor(R.styleable.ProgressButton_progress_border_color, DEFAULT_BORDER_COLOR);
        mTextColor = attributes.getColor(R.styleable.ProgressButton_progress_text_color, DEFAULT_TEXT_COLOR);
        mUnFinishedPressedColor = attributes.getColor(R.styleable.ProgressButton_progress_unfinished_pressed_color, getContext().getResources().getColor(
                android.R.color.darker_gray));
        mFinishedPressedColor = attributes.getColor(R.styleable.ProgressButton_progress_finished_pressed_color, Color.RED);
        progressRatio = attributes.getFloat(R.styleable.ProgressButton_progress_ratio, .0F);
        cornerRadius = (int) attributes.getDimension(R.styleable.ProgressButton_progress_corner_radius, DEFAULT_CORNER_RADIUS);
        text = attributes.getString(R.styleable.ProgressButton_progress_text);
        drawBorder = attributes.getBoolean(R.styleable.ProgressButton_progress_draw_border, true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(mReachedAreaRect, cornerRadius, cornerRadius, mReachedAreaPaint);
        ...
        canvas.drawRoundRect(mUnReachedAreaRect, cornerRadius, cornerRadius, mUnReachedAreaPaint);
